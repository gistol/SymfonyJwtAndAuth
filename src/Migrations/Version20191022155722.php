 ...
 */
final class Version20191022155722 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE question CHANGE source_id source_id INT DEFAULT NULL, CHANGE mode mode VARCHAR(255) DEFAULT NULL, CHANGE image_file_name image_file_name VARCHAR(255) DEFAULT NULL, CHANGE image_content_type image_content_type VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE question CHANGE source_id source_id INT NOT NULL, CHANGE mode mode VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, CHANGE image_file_name image_file_name VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, CHANGE image_content_type image_content_type VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci');
