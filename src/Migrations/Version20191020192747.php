 ...
 */
final class Version20191020192747 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE question DROP answers_id, DROP user_id, CHANGE image_updated_at image_updated_at DATETIME NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE question ADD answers_id INT DEFAULT NULL, ADD user_id INT NOT NULL, CHANGE image_updated_at image_updated_at VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci');
