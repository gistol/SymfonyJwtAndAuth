 ...
 */
final class Version20191015145335 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE notifications CHANGE user_id user_id VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci');
