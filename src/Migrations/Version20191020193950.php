 ...
 */
final class Version20191020193950 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE question CHANGE source_id source_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE question CHANGE source_id source_id VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci');
