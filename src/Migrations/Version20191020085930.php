 ...
 */
final class Version20191020085930 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE email email VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, CHANGE roles roles LONGTEXT NOT NULL COLLATE utf8mb4_bin, CHANGE password password VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, CHANGE first_name first_name VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, CHANGE last_name last_name VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, CHANGE bdate bdate DATETIME NOT NULL, CHANGE city_id city_id INT NOT NULL, CHANGE created_at created_at DATETIME NOT NULL, CHANGE updated_at updated_at DATETIME NOT NULL, CHANGE vk_id vk_id VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, CHANGE vk_token vk_token VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, CHANGE avatar_file_name avatar_file_name VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, CHANGE avatar_content_type avatar_content_type VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, CHANGE avatar_file_size avatar_file_size INT NOT NULL, CHANGE avatar_updated_at avatar_updated_at DATETIME NOT NULL, CHANGE avatar_meta avatar_meta LONGTEXT NOT NULL COLLATE utf8mb4_unicode_ci, CHANGE phone phone VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, CHANGE vk_phone vk_phone VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci');
    }
}
