 ...
 */
final class Version20191020193439 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE question CHANGE source_id source_id VARCHAR(255) NOT NULL, CHANGE image_updated_at image_updated_at VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE question CHANGE source_id source_id INT NOT NULL, CHANGE image_updated_at image_updated_at DATETIME NOT NULL');
