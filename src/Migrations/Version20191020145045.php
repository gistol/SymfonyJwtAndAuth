 ...
 */
final class Version20191020145045 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE levels (id INT AUTO_INCREMENT NOT NULL, number INT NOT NULL, title VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, course_id INT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, image_file_name VARCHAR(255) NOT NULL, image_content_type VARCHAR(255) NOT NULL, image_file_size INT NOT NULL, image_updated_at DATETIME NOT NULL, image_meta VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('ALTER TABLE answer CHANGE parent_id question_id INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE question ADD answers_id INT DEFAULT NULL, ADD user_id INT NOT NULL, DROP answer_id');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE acl_object_identities CHANGE parent_object_identity_id parent_object_identity_id INT UNSIGNED DEFAULT NULL');
        $this->addSql('ALTER TABLE answer CHANGE question_id parent_id INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE question ADD answer_id INT DEFAULT NULL, DROP answers_id, DROP user_id');
