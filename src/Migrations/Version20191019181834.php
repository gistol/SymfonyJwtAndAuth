 ...
 */
final class Version20191019181834 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE task (id INT AUTO_INCREMENT NOT NULL, number INT NOT NULL, topic_id INT NOT NULL, mode VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, level_id INT NOT NULL, export TINYINT(1) DEFAULT \'0\' NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE user ADD first_name VARCHAR(255) NOT NULL, ADD last_name VARCHAR(255) NOT NULL, ADD bdate DATETIME NOT NULL, ADD city_id INT NOT NULL, ADD created_at DATETIME NOT NULL, ADD updated_at DATETIME NOT NULL, ADD vk_id VARCHAR(255) NOT NULL, ADD vk_token VARCHAR(255) NOT NULL, ADD avatar_file_name VARCHAR(255) NOT NULL, ADD avatar_content_type VARCHAR(255) NOT NULL, ADD avatar_file_size INT NOT NULL, ADD avatar_updated_at DATETIME NOT NULL, ADD avatar_meta LONGTEXT NOT NULL, ADD phone VARCHAR(255) NOT NULL, ADD vk_phone VARCHAR(255) NOT NULL, CHANGE roles roles JSON NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE question CHANGE answer_id answer_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE user DROP first_name, DROP last_name, DROP bdate, DROP city_id, DROP created_at, DROP updated_at, DROP vk_id, DROP vk_token, DROP avatar_file_name, DROP avatar_content_type, DROP avatar_file_size, DROP avatar_updated_at, DROP avatar_meta, DROP phone, DROP vk_phone, CHANGE roles roles LONGTEXT NOT NULL COLLATE utf8mb4_bin');
    }
}
